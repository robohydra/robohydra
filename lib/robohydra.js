...
var InvalidRoboHydraResponse = function(plugin, test,  args) {
    this.name    = "InvalidRoboHydraResponse";
    this.message = 'No "end" event handler for this response object';
};
InvalidRoboHydraResponse.prototype.toString = function() {
    return "InvalidRoboHydraResponse";
};

var InvalidRoboHydraResponseEvent = function(eventName) {
    this.name    = "InvalidRoboHydraResponseEvent";
    this.message = 'There\'s no "' + eventName + '" event';
};
InvalidRoboHydraResponseEvent.prototype.toString = function() {
    return "InvalidRoboHydraResponseEvent";
};
...
Response.prototype.end = function(res) {
    if (this.eventHandlers.end.length) {
        for (var i = 0, len = this.eventHandlers.end.length; i < len; i++) {
            this.eventHandlers.end[i].call(this, this);
        }
    } else {
        throw new InvalidRoboHydraResponse(this);
    }
};
...
Response.prototype.on = function(eventName, cb) {
    if (this.eventHandlers.hasOwnProperty(eventName)) {
        ...
        throw new InvalidRoboHydraResponseEvent(eventName);
    }
};
