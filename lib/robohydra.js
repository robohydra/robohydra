...
(function () {
    ...
    var RoboHydra = function(extraVars) {
        ...
        var adminPluginConfig = extendObject(extraVars, {robohydra: this});
    ...
    RoboHydra.prototype._emptyPluginStructure = function(plugin) {
        var pluginToRegister = {
            name:      plugin.name,
            heads:     plugin.heads     || [],
            scenarios: plugin.scenarios || plugin.tests || {}
        };
        // Deprecated, only kept for compatibility for a while
    ...
    RoboHydra.prototype.startTest = function(pluginName, testName) {
        console.log("*** startTest is deprecated, please use startScenario ***");
    ...
    RoboHydra.prototype.stopTest = function() {
        console.log("*** stopTest is deprecated, please use stopScenario ***");
        this.stopScenario();
    };
