...
(function () {
    ...
    RoboHydra.prototype._emptyPluginStructure = function(plugin) {
        ...
        // Deprecated, only kept for compatibility for a while
        if (plugin.tests) {
            console.warn("*** Using 'tests' in a plugin is deprecated, please use 'scenarios' instead ***");
    ...
    RoboHydra.prototype.startTest = function(pluginName, testName) {
        console.warn("*** startTest is deprecated, please use startScenario ***");
    ...
    RoboHydra.prototype.stopTest = function() {
        console.warn("*** stopTest is deprecated, please use stopScenario ***");
        this.stopScenario();
    };
