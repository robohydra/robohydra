...
var InvalidRoboHydraNextParametersException = function(plugin, test,  args) {
    this.name    = "InvalidRoboHydraNextParametersException";
...
InvalidRoboHydraNextParametersException.prototype.toString = function() {
    return "InvalidRoboHydraNextParametersException";
};
