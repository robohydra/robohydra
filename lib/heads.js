...
RoboHydraHead.prototype._baseOptionalProperties  = ['name', 'detached'];
RoboHydraHead.prototype._optionalProperties  = [];
RoboHydraHead.prototype._checkProperties = function(props) {
    ...
    for (var p in props) {
        if (this._mandatoryProperties.indexOf(p) === -1 &&
                ...
                this._baseOptionalProperties.indexOf(p) === -1) {
...
RoboHydraHeadStatic.prototype._optionalProperties = ['path', 'responses', 'content', 'statusCode', 'contentType'];
...
RoboHydraHeadFilesystem.prototype._optionalProperties = ['mountPath', 'fs', 'mime'];
...
RoboHydraHeadProxy.prototype._optionalProperties = ['mountPath', 'httpRequestFunction', 'setHostHeader'];
...
for (p in RoboHydraHead.prototype) {
    RoboHydraHeadFilter.prototype[p] = RoboHydraHead.prototype[p];
}
RoboHydraHeadFilter.prototype.type = 'filter';
RoboHydraHeadFilter.prototype._mandatoryProperties = ['filter'];
RoboHydraHeadFilter.prototype._optionalProperties = ['path'];
// RoboHydraHeadFilter.prototype._handle = function(req, res) {};
