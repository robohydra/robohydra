...
Hydra.prototype.getAssertionFunction = function(assertion) {
    var thisHydra = this;
    return function() {
        var currentTestPlugin = thisHydra.currentTest.plugin,
            currentTestName   = thisHydra.currentTest.test;
        var result =
            thisHydra.testResults[currentTestPlugin][currentTestName];
...
Hydra.prototype.getUtilsObject = function() {
