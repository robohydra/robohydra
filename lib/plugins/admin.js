...
exports.getBodyParts = function(config) {
    return [
        ...
        new HydraHeadFilesystem({name: 'static',
                                 mountPath: hydraAdminBaseUrlPath + '/static',
        ...
        new HydraHead({
            ...
            path: hydraAdminBaseUrlPath + '/tests/results.json',
            handler: function(req, res) {
                res.headers['content-type'] =
                    'application/json; charset=utf-8';
                res.send(JSON.stringify(config.hydra.testResults));
            }
        }),
        ...
        new HydraHead({
            ...
            handler: function(req, res) {
                ...
                if (req.getParams.highlightPath) {
                    var matchingPair =
                        config.hydra.headForPath(stash.highlightPath);
                    if (matchingPair) {
